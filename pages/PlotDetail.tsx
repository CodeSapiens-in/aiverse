...
export default function PlotDetail({ id, onNavigate }: PlotDetailProps) {
    ...
    const handleAddCharacter = () => {
        ...
        try {
            ...
            refreshPlot();
            setNewChar({ name: '', role: 'Sidekick', traits: [], characterization: '', submittedBy: '' });
        } catch (e: any) {
            alert(e.message);
        }
    };
                ...
                <div className="space-y-6">
                    ...
                    {showAddChar && (
                        <Card className="animate-in slide-in-from-top-2 border-story-accent">
                            ...
                            <Input placeholder="Archetype / Role" list="role-options" value={newChar.role} onChange={(e: any) => setNewChar({ ...newChar, role: e.target.value })} />
